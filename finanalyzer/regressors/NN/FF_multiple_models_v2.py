...
models_topology = [[[512,"relu"],[256,"sigmoid"]],
                   ...
                   [[128,"relu"],[64,"sigmoid"]],
                   [[512,"relu"],[256,"relu"],[128,"sigmoid"]],
                   [[256,"relu"],[128,"relu"],[64,"sigmoid"]],
                   [[128,"relu"],[64,"relu"],[32,"sigmoid"]],
                   [[1024,"relu"],[512,"relu"],[256,"relu"],[128,"sigmoid"]],
                   [[512,"relu"],[256,"relu"],[128,"relu"],[64,"sigmoid"]],
                   [[256,"relu"],[128,"relu"],[64,"relu"],[32,"sigmoid"]],
                   [[2048,"relu"],[1024,"relu"],[512,"relu"],[256,"relu"],[128,"sigmoid"]],
                   [[1024,"relu"],[512,"relu"],[256,"relu"],[128,"relu"],[64,"sigmoid"]],
                   [[512,"relu"],[256,"relu"],[128,"relu"],[64,"relu"],[32,"sigmoid"]],
                   [[4096,"relu"],[2048,"relu"],[1024,"relu"],[512,"relu"],[256,"relu"],[128,"sigmoid"]],
                   [[2048,"relu"],[1024,"relu"],[512,"relu"],[256,"relu"],[128,"relu"],[64,"sigmoid"]],
                   [[1024,"relu"],[512,"relu"],[256,"relu"],[128,"relu"],[64,"relu"],[32,"sigmoid"]],
...
shutil.copyfile("FF_multiple_models_v2.py", path_working_folder+"FF_multiple_models_v2.py")
...
for topology in models_topology :
    models.append(build_model((input_shape,), output_shape, topology))
    models_name.append("FF_"+str(len(topology))+"Layers")
    model_path = path_working_folder + models_name[-1]
...
for epoch in range(epochs):
    ...
    with tqdm.tqdm(
        ...
        for batch_coords in train_dataset:
            ...
            batch_inputs, batch_outputs = create_batch(points_list=batch_coords, files_array=files_array, length_files=length_files, n_inputs=n_inputs, n_outputs=n_outputs,length_input_timeseries=input_shape, length_output_timeseries=output_shape)
            t_train -= time.time()

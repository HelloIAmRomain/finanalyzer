...
# from tensorflow.keras.layers import Dense, InputLayer, Flatten, Activation, Reshape, Dropout
...
def build_model(input_shape, output_shape, topology):
    """
    Build a Transformer model (NLP) for time series
    """
    # Input
    inputs = keras.Input(shape=input_shape, name="input")
    # Transformer
    transformer_block = keras.layers.TransformerEncoderBlock(
...
models_topology = [
    ...
    # [[20, "relu", "sigmoid"]],
    # [[14, "relu", "sigmoid"]],
    [[70, "relu", "sigmoid"], [35, "relu", "sigmoid"]],
    ...
    [[70, "relu", "sigmoid"], [35, "relu", "sigmoid"], [28, "relu", "sigmoid"]],

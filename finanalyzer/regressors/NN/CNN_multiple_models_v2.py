        ...
        for input_layer in input_layers :
            for kernel_size in kernel_sizes :
                if kernel_size <= input_layer[0] :
                    list_topologies.append([[input_shape,kernel_size],(input_layer[0]-kernel_size+1,input_layer[1]-kernel_size+1)])
...
def create_name_list(list_topologies):
    ...
    list_names = []
    for topology in list_topologies :
        name = "CNN_" + str(len(topology)-1) + "layers_" + str(topology[0][0]) + "x" + str(topology[0][1]) + "input_" + str(topology[1][0]) + "x".join([str(topo[1]) for topo in topology[1:]]) + "k"

...
for test_bin_path in testFiles :
    ...
    file_array= file_array.reshape((int(len(file_array)/2),2))
    ...
    for m in range(len(models)) :
        ...
        for coord_batch in test_dataset :
            ...
            batch_inputs, batch_outputs = create_batch(points_list=coord_batch, files_array=[file_array], length_files=[length_test_file], n_inputs=1, n_outputs=1,length_input_timeseries=length_input_timeseries, length_output_timeseries=length_output_timeseries)
